...
class EmployeeController extends Controller
{
    ...
    public function show($id)
    {
        try {
            ...
            return response()->json(['success' => true, 'message' => 'Employees added successfully', 'data' => $employee]);
        } catch (\Throwable $th) {
            Log::error('Failed insert : ' . $th->getMessage());
            return response()->json(['success' => false, 'message' => 'Failed Create Employees'], 500);
        }
    ...
    {
        try {
            $employee = Employees::with('user')->delete();
            return response()->json(['message' => 'Employee deleted successfully', 'data' => $employee]);
        } catch (\Throwable $th) {
